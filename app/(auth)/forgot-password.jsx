...
import MyInput from "../../components/share/MyInput"; // Assuming MyInput is a reusable component
        ...
        <View>
          ...
          <View className="flex items-center justify-center pt-10">
            <Image
              ...
              style={{ width: 233, height: 235 }} // Cập nhật style để tránh lỗi
            />
          </View>

          <View className="flex items-center justify-center">
            <Text className="font-mbold text-[32px] text-light-500 ">
              OTP Verification
            </Text>
            <Text className="font-mmedium text-[16px] text-light-500 pt-4">
              Nhập OTP được gửi đến số điện thoại{" "}
            </Text>
            <Text className="font-mbold text-[16px] text-light-500 pt-1">
              +84 123456789
            </Text>
          </View>
          ...
          <View className="flex items-center justify-center pt-8">
            {otpExpired ? (
              <Text className="font-mmedium text-[16px] text-light-500 ">
